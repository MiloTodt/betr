...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { date: @bet.date, fighter: @bet.fighter, margin: @bet.margin, odds: @bet.odds } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { date: @bet.date, fighter: @bet.fighter, margin: @bet.margin, odds: @bet.odds } }
